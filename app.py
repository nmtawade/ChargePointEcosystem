...
def generate_summary_dataframe(df):
    ...
    for _, row in tqdm(df.iterrows(), total=df.shape[0], desc="Generating Summaries"):
        ...
        print("Inside generate_summary_dataframe-station_id", station_id)
        print("Inside generate_summary_dataframe-reviews", reviews)
    ...
    display("Inside generate_summary_dataframe-summaries generated by model",summaries)
    return summaries
